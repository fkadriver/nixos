...
echo "Run the following to add both public keys to authorized_keys:"
echo ""
echo "  grep -qF \"\$(cat ~/.ssh/id_ed25519.pub)\" ~/.ssh/authorized_keys \\"
...
echo ""
echo "Key usage:"
echo "  id_ed25519        — latitude"
echo "  id_ed25519_legacy — vm01, airbook-darwin, and borg-* shell aliases"
echo ""
