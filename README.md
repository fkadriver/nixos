...
├── homeConfigurations/    # Standalone Home Manager config (scott.nix)
├── secrets/               # Encrypted secrets (sops-nix)
├── scripts/               # Deployment/maintenance scripts
├── examples/              # Example module usage
├── archive/               # Retired hosts & modules (kept for reference)
└── docs/                  # Documentation
```
...
| [docs/idrive360.md](docs/idrive360.md) | IDrive360 VM provisioning (ops/troubleshooting moved to [fkadriver/idrive360](https://github.com/fkadriver/idrive360)) |
